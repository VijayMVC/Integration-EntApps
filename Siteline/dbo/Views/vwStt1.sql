...
SELECT     dbo.tblStt.SttDate, dbo.tblStt.Stt_CtrID, dbo.tblStt.Stt_BdgID, dbo.tblStt.Stt_BdgYear, dbo.tblStt.SttID, dbo.tblStt.SttKey, dbo.tblStt.SttLink, dbo.tblStt.SttAccExpenseAmt, 
                      ...
                      dbo.tblStt.YTDSttPTOAccrual, dbo.tblStt.YTDSttPTOTotalCost, dbo.tblStt.YTDSttPTOTrueUpAdj, dbo.tblCmp.CmpName AS Site, dbo.tblStt.SttPublishYN, 
                      dbo.tblStt.SttEncounterQty, dbo.tblStt.SttBilledUnitQty, dbo.tblStt.SttNetRevPerEncounter, dbo.tblStt.SttNetRevPerBilledUnit, dbo.tblStt.SttAvgChgEncounter, 
                      dbo.tblStt.SttAvgChgBilledUnit, dbo.tblStt.SttCollPerEncounter, dbo.tblStt.SttCollPerBilledUnit, dbo.tblStt.SttTotalCollAmtPerEncounter, 
                      dbo.tblStt.SttTotalCollAmtperBilledUnit, dbo.tblStt.YTDSttEncounterQty, dbo.tblStt.YTDSttBilledUnitQty, dbo.tblStt.YTDSttNetRevPerEncounter, 
                      dbo.tblStt.YTDSttNetRevPerBilledUnit, dbo.tblStt.YTDSttAvgChgEncounter, dbo.tblStt.YTDSttAvgChgBilledUnit, dbo.tblStt.YTDSttCollPerEncounter, 
                      dbo.tblStt.YTDSttCollPerBilledUnit, dbo.tblStt.YTDSttTotalCollAmtPerEncounter, dbo.tblStt.YTDSttTotalCollAmtperBilledUnit
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwStt1';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwStt1';
