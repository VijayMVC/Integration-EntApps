...
AS
SELECT     dbo.tblResults.ResultsID, dbo.tblResults.ResultsForeignKey, dbo.tblStt.SttDate, dbo.tblStt.Stt_CtrID, dbo.tblStt.Stt_BdgID, dbo.tblStt.Stt_BdgYear, dbo.tblStt.SttID, 
                      ...
                      dbo.tblStt.YTDSttPTOAccrual, dbo.tblStt.YTDSttPTOTotalCost, dbo.tblStt.YTDSttPTOTrueUpAdj, dbo.tblStt.SttPublishYN
FROM         dbo.tblResults INNER JOIN
                      dbo.tblStt ON dbo.tblResults.ResultsForeignKey = dbo.tblStt.SttID
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwResults';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwResults';
