CREATE Procedure UpdateStatsAll
AS
/*Create temporary tablefor all contracts */
Create table #tblX (
  XID int identity (1,1),
  XCtrID int)
  
insert into #tblX (XCtrID)
 Select CtrID from tblCtr
/*Declare variables for navigating in recordset */
Declare  @XCountRecords int,
  @XintCounter int
Select  @XCountRecords = Count(*),
 @XintCounter = 1
From #tblX
While @XintCounter <= @XCountRecords
begin
Declare  @CtrID int
Select @CtrID = XCtrID
From #tblX
Where XID = @XintCounter
