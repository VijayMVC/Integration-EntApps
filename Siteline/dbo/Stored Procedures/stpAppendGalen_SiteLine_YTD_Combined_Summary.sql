CREATE PROCEDURE [dbo].[stpAppendGalen_SiteLine_YTD_Combined_Summary]
(@sttDate datetime)
...
truncate table tblGalen_SiteLine_YTD_Combined_Report

INSERT INTO tblGalen_SiteLine_YTD_Combined_Report
                      (SttDate, PostActPrcBud, SumytdSttPstChgs, PostActPerPt, SumytdBdgPstChg, EstColRtActTot, EstColRtActPerPt, EstColRtBudTot, 
                      EstGrsColActPrcBud, SumytdGrossColl, EstGrsColActPerPt, SumytdBdgGrossColl, StpdRecActPrtBud, SumytdStipendsRcvd, StpdRecActPerPt, 
                      SumytdBdgStipendsRcvd, OthRecActPrtBud, SumytdOtherRcpts, OthRecActPerPt, SumytdBdgOthRcpts, SumytdWIPGainLoss, WIPActPerPt, 
                      SumytdValuationGainLoss, ValGainActPerPt, EstTotRevActPrtBud, SumytdTotalColl, EstTotRevActPrtRev, EstTotRevActPerPt, SumytdBdgTotalColl, 
                      MalActPrtBud, SumytdMalpractice, MalActPrtRev, MalActPerPt, SumytdBdgMalpractice, BilActPrtBud, SumytdSttBillFee, BilActPrtRev, BilActPerPt, 
                      SumytdBdgBillFee, SumYtdSttCollFeeChgAmt, FutColActPerPt, IntActPrtBud, SumytdInterest, IntActPrtRev, IntActPerPt, SumytdbdgInterest, 
                      OtpExpActPrtBud, OtpExpActTot, OtpExpActPrtRev, OtpExpActPerPt, OtpExpBudTot, StPerActPrtBud, StPerActTot, StPerActPrtRev, StPerActPerPt, 
                      SumytdBdgBillSpec, NORActPrtBud, SumytdNOR, NORActPrtNOR, NORActPrtRev, NORActPerPt, SumytdBdgNOR, /*NORBudPrtNOR,*/ PhPayActPrtBud, 
                      PhPayActTot, PhPayActPrtNOR, PhPayActPrtRev, PhPayActPerPt, SumytdBdgPITEarned, PhPayBudPRtNOR, MLPayActPrtBud, MLPayActTot, 
                      MLPayAcPrtNOR, MLPayActPrtRev, MLPayActPerPt, SumytdBdgPACost, MLPayBudPrtNor, LExpBud, LExpActPrtBud, LExpActTot, LExpActPrtNOR, 
                      LExpActPrtRev, LExpActPerPt, SumytdBdgLclExp, LExpBudPrtNOR, OthPayActTot, OthPayActPrtNOR, OthPayActPrtRev, OthPayActPerPt, 
                      MedDPayActPRtBud, SumytdSttMDPaidAmt, MedDPayActPrtNOR, MedDPayActPrtRev, MedDPayActPerPt, SumytdBdgMDearned, MedDPayBudPrtNOR, 
                      RgDPayActPrtBud, RgDPayActTot, RgDPayActPrtNOR, RgDPayActPrtRev, RgDPayActPerPt, SumytdBdgRDearned, RgDPayBudPrtNOR, DCntActPrtBud, 
                      SumytdContribCEP, DCntActPrtNOR, DCntActPrtRev, DCntActPerPt, SumytdBdgContribCEP, DCntBudPrtNOR, SumytdSiteNetInc, SNIncActPrtNor, 
                      SNIncActPrtRev, SNIncActPerPt, SumytdBdgSiteNetInc, SNIncBudPrtNOR, PatVisBud1, PatVisBud2, SumytdBdgPatients, PatKyd, PatEnct, PatBdgEnct, 
                      DlyEnct, DlyBdgEnct, PhHr1, SumytdDocHours, PhHr3, SumytdBdgDocHours, PhEHr1, PhEHr2, PhEHr3, PhPayHr1, PhPayHr2, MLHr1, 
                      SumytdPAHours, MLHr3, SumytdBdgPAHours, MLCostHr1, MLCostHr2, MLCostHr3, PtsPerMDHrOnly1, PtsPerMDHrOnly2, PtsPerMDHrOnly3, 
                      PtsPerMDandMLHr1, PtsPerMDandMLHr2, PtsPerMDandMLHr3, AvChPerPat1, AvChPerPAt2, AvChPerPAt3, EstColPerPat1, EstColPerPat2, 
                      EstColPerPat3, EstTotRevPerPat1, EstTotRevPerPat2, EstTotRevPerPat3, EstNORPerPat1, EstNORPerPat2, EstNORPerPat3, 
                      SumYtdSttACCExpenseAmt, OpExpPrtRev, OpExpPerPt, SumYtdSiteOverhead, StOvhdPrtRev, StOvhdPerPt, ACCStOvdTotYTD, ACCStOvdTotPrtRev, 
                      ACCStOvdTotPerPt, DonatYTD, DonatPrtRev, DonatPerPt, AlOthExpYTD, AlOthExpPrtRev, AlOthExpPerPt, CEPretYtd, CEPretPrtRec, CEPretPerPt, 
                      OTpExpTotYtd, OTpExpPrtRev, OTpExpPerPt, MaAdminYtd, MaAdminPrtRev, MaAdminPerPt, DCodPerYtd, DCodPerPrtRev, DCodPerPerPt, CEPScbYtd, 
                      CEPScbPrtRev, CEPScbPerPt, CEPScbPTOYtd, CEPScbPTOPrtRev, CEPScbPTOPerPt, CEPStPerYtd, CEPStPerPrtRev, CEPStPerPerPr, 
                      CEPStPerPTOYtd, CEPStPerPTOPrtRev, CEPStPerPTOPerPt, NClStfTotYtd, NClStfTotPRtRev, NClStfTotPerPt, MLvExpYtd, MLvExpPrtNOR, 
                      MLvExpPrtRev, MLvExpPerPt, MlvPTOExpYtd, MlvPTOExpPrtNOR, MlvPTOExpPrtRev, MlvPTOExpPerPt, LMLvCstSupYtd, LMLvCstSupPrtNor, 
                      LMLvCstPrtRev, LMLvCstSupPerPt, MlvCstTotYtd, MlvCstTotPrtNOR, MlvCstTotPrtRev, MlvCstTotPerPt, PTExpYtd, PTExpPrtNOR, PTExpPrtRev, 
                      PTExpPerPt, PTPTOExpYtd, PTPTOExpPrtNOR, PTPTOExpPrtRev, PTPTOExpPerPt, PTCstTotYtd, PTCstTotPrtNOR, PTCstTotPrtRev, PTCstTotPerPt, 
                      LcExpYtd, LcExpPrtNOR, LcExpPrtRev, LcExpPerPt, OthLcExpYtd, OthLcExpPrtNOR, OthLcExpPerPt, OthLcExpPerPt1, TotLcExpCstYtd, 
...
select SttDate,
case when Sum([ytdBdgPstChgs]) = 0 then '0' else convert (varchar(50),convert(float,(Sum([ytdSttPstChgs])-Sum([ytdBdgPstChgs]))/Sum([ytdBdgPstChgs])*100,2))+'%' end as PostActPrcBud,
...
case when Sum([ytdBdgGrossColl]) = 0 then '0' else convert (varchar(50),convert(float,round((Sum([ytdGrossColl])-Sum([ytdBdgGrossColl]))/Sum([ytdBdgGrossColl])*100,0),2))+'%' end as EstGrsColActPrcBud,
...
dbo.fn_removeMinusSign(dbo.fn_FormatWithCommas(convert (varchar(50),convert(int,Sum([ytdBdgGrossColl]),0)))),
...
dbo.fn_FormatWithCommas(convert (varchar(50),convert(int,Sum([ytdBdgStipendsRcvd]),0))),
...
dbo.fn_FormatWithCommas(convert (varchar(50),dbo.fn_removeMinusSign(convert(int,Sum([ytdOtherRcpts]),0)))) as SumytdOtherRcpts,
case when Sum([ytdSttPatVisitQty]) = 0 then '0' else dbo.fn_removeMinusSign(convert (varchar(50),convert(float,round(Sum([ytdOtherRcpts])/Sum([ytdSttPatVisitQty]),2),2))) end as OthRecActPerPt,
dbo.fn_FormatWithCommas(convert (varchar(50),dbo.fn_removeMinusSign(convert(int,Sum([ytdBdgOthRcpts]),0))))   as SumytdBdgOthRcpts,

dbo.fn_FormatWithCommas(convert (varchar(50),convert(int,Sum([ytdWIPGainLoss]),0))), 
case when Sum([ytdSttPatVisitQty]) = 0 then '0' else convert (varchar(50),convert(float,round(Sum([ytdWIPGainLoss])/Sum([ytdSttPatVisitQty]),2),2)) end as WIPActPerPt,
...
dbo.fn_removeMinusSign(dbo.fn_FormatWithCommas(convert (varchar(50),convert(int,Sum([ytdTotalColl]),0)))),
...
dbo.fn_removeMinusSign(dbo.fn_FormatWithCommas(convert (varchar(50),convert(int,(Sum([ytdSttOffTop])+Sum([YtdSttDonationAmt])+Sum([YtdSttCEPSurchargeAmt])),0)))),
...
--	else '%'+convert (varchar(50),convert(int,(Sum([ytdBdgPITEarned])/Sum([ytdBdgNOR]))+(Sum([ytdSttDocPaidAmt])+Sum([ytdSttDocPaidAmtAdj]))/Sum([ytdTotalColl])+(Sum([ytdBdgLclExp])/Sum([ytdBdgNOR]))+(Sum([ytdBdgMDearned])/Sum([ytdBdgNOR]))+(Sum([ytdBdgRDearned])/Sum([ytdBdgNOR]))+(Sum([ytdBdgContribCEP])/Sum([ytdBdgNOR]))+(Sum([ytdBdgSiteNetInc])/Sum([ytdBdgNOR])),0)) end as NORBudPrtNOR
...
case when Sum([ytdBdgNOR]) = 0 then '0' else convert (varchar(50),convert(float,round((Sum([ytdBdgPITEarned])/Sum([ytdBdgNOR]))*100,2),2))+'%' end as PhPayBudPRtNOR,

case when Sum([ytdBdgPACost]) = 0 then '0' else convert (varchar(50),convert(float,round(((Sum([ytdSttPTOTotalCost])+Sum([YtdSttPACost])-Sum([YtdSttPASupportCostAmt]))-Sum([ytdBdgPACost]))/Sum([ytdBdgPACost])*100,0),2))+'%' end as MLPayActPrtBud,
...
case when Sum([ytdNOR]) = 0 then '0' else convert (varchar(50),convert(float,round(((Sum([ytdSttDocPaidAmt])+Sum([ytdSttDocPaidAmtAdj]))/Sum([ytdNOR]))+((Sum([ytdSttPTOTotalCost])+Sum([YtdSttPACost])-Sum([YtdSttPASupportCostAmt]))/Sum([ytdNOR]))+((Sum([ytdSttLclExp])+Sum([YtdSttLclVarAmt])+Sum([YtdSttFixedLocalAmt]))/Sum([ytdNOR]))+((Sum([ytdSttLclExp])+Sum([YtdSttLclVarAmt])+Sum([YtdSttFixedLocalAmt])))+(Sum([ytdSiteNetInc])/Sum([ytdNOR])),2),2))+'%' end ,
...
case when Sum([ytdSttPatVisitQty]) = 0 then '0' else convert (varchar(50),convert(float,round((Sum([ytdSttLclExp])+Sum([YtdSttLclVarAmt])+Sum([YtdSttFixedLocalAmt]))/Sum([ytdSttPatVisitQty]),2),0)) end,
dbo.fn_FormatWithCommas(convert (varchar(50),convert(int,Sum([ytdBdgLclExp]),0))),
case when Sum([ytdBdgNOR]) = 0 then '0' else convert (varchar(50),convert(float,round((Sum([ytdBdgLclExp])/Sum([ytdBdgNOR]))*100,2),0))+'%' end,
...
case when Sum([ytdNOR]) = 0 then '0' else dbo.fn_removeMinusSign(convert (varchar(50),convert(float,round((((Sum([ytdSttLclExp])+Sum([YtdSttLclVarAmt])+Sum([YtdSttFixedLocalAmt])))/Sum([ytdNOR]))*100,1),2))+'%') end,
case when Sum([ytdTotalColl]) = 0 then '0' else convert (varchar(50),convert(float,round(((Sum([ytdSttLclExp])+Sum([YtdSttLclVarAmt])+Sum([YtdSttFixedLocalAmt])))/Sum([ytdTotalColl])*100,1),2))+'%' end,
...
case when Sum([ytdBdgNOR]) = 0 then '0' else convert (varchar(50),convert(float,round((Sum([ytdBdgMDearned])/Sum([ytdBdgNOR]))*100,2),2))+'%'end,
...
case when Sum([ytdBdgNOR]) = 0 then '0' else convert (varchar(50),convert(float,round((Sum([ytdBdgRDearned])/Sum([ytdBdgNOR]))*100,2),2))+'%' end,
...
case when Sum([ytdBdgNOR]) = 0 then '0' else convert (varchar(50),convert(float,round((Sum([ytdBdgContribCEP])/Sum([ytdBdgNOR]))*100,2),2))+'%' end,

dbo.fn_removeMinusSign(dbo.fn_FormatWithCommas(convert (varchar(50),convert(int,Sum([ytdSiteNetInc]),0)))),
...
case when Sum([ytdTotalColl]) = 0 then '0' else dbo.fn_removeMinusSign(convert (varchar(50),convert(float,round(Sum([ytdSiteNetInc])/Sum([ytdTotalColl])*100,2),2)))+'%' end,
case when Sum([ytdSttPatVisitQty]) = 0 then '0' else dbo.fn_removeMinusSign(convert (varchar(50),convert(float,round(Sum([ytdSiteNetInc])/Sum([ytdSttPatVisitQty]),2),2))) end,
...
case when Sum([ytdBdgPatients]) = 0 then '0' else convert (varchar(50),convert(float,round((Sum([ytdSttPatVisitQty])-Sum([ytdBdgPatients]))/Sum([ytdBdgPatients]),0),2))+'%' end,
...
dbo.fn_FormatWithCommas(convert (varchar(50),convert(int,Sum([YtdSttAdmitQty]),0))),
dbo.fn_FormatWithCommas(convert (varchar(50),convert(int,Sum([YTDBdgEncounters]),0))),
'1', --Create last day calc: originally Sum([YtdSttAdmitQty])/DateDiff('d',StartDayCalc([SttDate]),LastDayCalc([SttDate]))
'1', --Create last day calc: Sum([YTDBdgEncounters])/DateDiff('d',StartDayCalc([SttDate]),LastDayCalc([SttDate]))

case when Sum([ytdBdgDocHours]) = 0 then '0' else convert (varchar(50),convert(float,round((Sum([ytdDocHours])-Sum([ytdBdgDocHours]))/Sum([ytdBdgDocHours]),0)*100,0))+'%' end,
dbo.fn_FormatWithCommas(convert (varchar(50),convert(int,Sum([ytdDocHours]),0))),
case when (Sum([ytdDocHours])+Sum([ytdPAHours])) = 0 then '0' else convert (varchar(50),convert(float,round(Sum([ytdDocHours])/(Sum([ytdDocHours])+Sum([ytdPAHours])),0)*100,0))+'%' end,
...
case when Sum([ytdDocHours]) = 0 then '0' else '$'+dbo.fn_FormatWithCommas(convert (varchar(50),convert(float,round((Sum([YtdPITearned])/Sum([ytdDocHours])),2),0))) end,
case when Sum([ytdBdgDocHours]) = 0 then '0' else '$'+dbo.fn_FormatWithCommas(convert (varchar(50),convert(float,round((Sum([ytdBdgPITEarned])/Sum([ytdBdgDocHours])),2),0))) end,

case when Sum([ytdDocHours]) = 0 then '0' else '$'+dbo.fn_FormatWithCommas(convert (varchar(50),convert(float,round((Sum([ytdSttDocPaidAmt])+Sum([ytdSttDocPaidAmtAdj]))/Sum([ytdDocHours]),2),0))) end,
case when Sum([ytdDocHours]) = 0 then '0' else '$'+dbo.fn_FormatWithCommas(convert (varchar(50),convert(float,round(((Sum([ytdSttDocPaidAmt])+Sum([ytdSttDocPaidAmtAdj]))+Sum([YtdSttSurplusPayout]))/Sum([ytdDocHours]),2),0))) end,

case when Sum([ytdBdgPAHours]) = 0 then '0' else dbo.fn_removeMinusSign(convert (varchar(50),convert(float,round((Sum([ytdPAHours])-Sum([ytdBdgPAHours]))/Sum([ytdBdgPAHours])*100,0),0)))+'%' end,
dbo.fn_removeMinusSign(dbo.fn_FormatWithCommas(convert (varchar(50),convert(int,Sum([ytdPAHours]),0)))),
case when (Sum([ytdDocHours])+Sum([ytdPAHours])) = 0 then '0' else dbo.fn_removeMinusSign(convert (varchar(50),convert(float,round(Sum([ytdPAHours])/(Sum([ytdDocHours])+Sum([ytdPAHours]))*100,0),0))+'%') end,
dbo.fn_removeMinusSign(dbo.fn_FormatWithCommas(convert (varchar(50),convert(int,Sum([ytdBdgPAHours]),0)))),
...
case when Sum([ytdPAHours]) = 0  or Sum([ytdBdgPAHours]) =0 or (Sum([ytdSttPTOTotalCost])+Sum([YtdSttPACost])-Sum([YtdSttPASupportCostAmt])) = 0 then '0' 
	else dbo.fn_removeMinusSign(convert (varchar(50),convert(float,round((((Sum([ytdSttPTOTotalCost])+Sum([YtdSttPACost])-Sum([YtdSttPASupportCostAmt]))/Sum([ytdPAHours]))-(Sum([ytdBdgPACost])/Sum([ytdBdgPAHours])))/((Sum([ytdSttPTOTotalCost])+Sum([YtdSttPACost])-Sum([YtdSttPASupportCostAmt]))/Sum([ytdPAHours]))*100,0),0))+'%' )end,
...
case when Sum([ytdBdgDocHours]) = 0 or Sum([ytdDocHours]) = 0  or Sum([ytdBdgPatients]) = 0  then '0' else dbo.fn_removeMinusSign(convert (varchar(50),convert(float,round(((Sum([ytdSttPatVisitQty])/Sum([ytdDocHours]))-(Sum([ytdBdgPatients])/Sum([ytdBdgDocHours])))/(Sum([ytdBdgPatients])/Sum([ytdBdgDocHours]))*100,0),0))+'%') end,
case when Sum([ytdDocHours]) = 0 then '0' else dbo.fn_removeMinusSign(dbo.fn_FormatWithCommas(convert (varchar(50),convert(float,round((Sum([ytdSttPatVisitQty])/Sum([ytdDocHours])),1),0)))) end,
case when Sum([ytdBdgDocHours]) = 0 or Sum([ytdBdgDocHours]) = 0 then '0' else dbo.fn_removeMinusSign(dbo.fn_FormatWithCommas(convert (varchar(50),convert(float,round((Sum([ytdBdgPatients])/Sum([ytdBdgDocHours])),1),0)))) end,
...
case when (Sum([ytdDocHours])+Sum([ytdPAHours])) = 0 or (Sum([ytdBdgDocHours])+Sum([ytdBdgPAHours])) = 0 or Sum([ytdBdgPatients]) = 0 or (Sum([ytdBdgDocHours])+Sum([ytdBdgPAHours])) = 0 then '0' 
	else dbo.fn_removeMinusSign(convert (varchar(50),convert(float,round(((Sum([ytdSttPatVisitQty])/(Sum([ytdDocHours])+Sum([ytdPAHours])))-(Sum([ytdBdgPatients])/(Sum([ytdBdgDocHours])+Sum([ytdBdgPAHours]))))/(Sum([ytdBdgPatients])/(Sum([ytdBdgDocHours])+Sum([ytdBdgPAHours])))*100,0),0))+'%') end,
case when (Sum([ytdDocHours])+Sum([ytdPAHours])) = 0 then '0' else dbo.fn_removeMinusSign(convert (varchar(50),convert(float,round((Sum([ytdSttPatVisitQty])/(Sum([ytdDocHours])+Sum([ytdPAHours]))),1),0))) end,
case when (Sum([ytdBdgDocHours])+Sum([ytdBdgPAHours])) = 0 then '0' else dbo.fn_removeMinusSign(convert (varchar(50),convert(float,round((Sum([ytdBdgPatients])/(Sum([ytdBdgDocHours])+Sum([ytdBdgPAHours]))),1),0))) end,

case when Sum([ytdSttPtsKeyed]) = 0 or Sum([ytdBdgPatients]) = 0  or Sum([ytdBdgPstChgs]) = 0 or Sum([ytdBdgPatients]) = 0 then '0' 
	else dbo.fn_removeMinusSign(convert (varchar(50),convert(float,round(((Sum([ytdSttPstChgs])/Sum([ytdSttPtsKeyed]))-(Sum([ytdBdgPstChgs])/Sum([ytdBdgPatients])))/(Sum([ytdBdgPstChgs])/Sum([ytdBdgPatients]))*100,0),0))+'%') end,
case when Sum([ytdSttPtsKeyed]) = 0 then '0' else '$'+convert (varchar(50),convert(float,round((Sum([ytdSttPstChgs])/Sum([ytdSttPtsKeyed])),2),0)) end,
case when Sum([ytdBdgPatients]) = 0 then '0' else dbo.fn_removeMinusSign('$'+convert (varchar(50),convert(float,round((Sum([ytdBdgPstChgs])/Sum([ytdBdgPatients])),2),0))) end,

case when Sum([ytdSttPatVisitQty]) = 0 or Sum([ytdSttPatVisitQty]) = 0 or Sum([ytdBdgPatients]) = 0 or Sum([ytdBdgGrossColl]) = 0 then '0' 
	else dbo.fn_removeMinusSign(convert (varchar(50),convert(float,round((((Sum([ytdTotalColl])-Sum([ytdOtherRcpts])-Sum([ytdStipendsRcvd]))/Sum([ytdSttPatVisitQty]))-(Sum([ytdBdgGrossColl])/Sum([ytdBdgPatients])))/(Sum([ytdBdgGrossColl])/Sum([ytdBdgPatients]))*100,0),0))+'%') end,
case when Sum([ytdSttPatVisitQty]) = 0 then '0' else '$'+convert (varchar(50),convert(float,round(((Sum([ytdTotalColl])-Sum([ytdOtherRcpts])-Sum([ytdStipendsRcvd]))/Sum([ytdSttPatVisitQty])),2),0)) end,
case when Sum([ytdBdgPatients]) = 0 then '0' else '$'+convert (varchar(50),convert(float,round((Sum([ytdBdgGrossColl])/Sum([ytdBdgPatients])),2),0)) end,

case when Sum([ytdSttPatVisitQty]) = 0 or Sum([ytdBdgPatients]) = 0  or Sum([ytdBdgTotalColl]) = 0   then '0' 
	else dbo.fn_removeMinusSign(convert (varchar(50),convert(float,round(((Sum([ytdTotalColl])/Sum([ytdSttPatVisitQty]))-(Sum([ytdBdgTotalColl])/Sum([ytdBdgPatients])))/(Sum([ytdBdgTotalColl])/Sum([ytdBdgPatients]))*100,0),0))+'%') end,
case when Sum([ytdSttPatVisitQty]) = 0 then '0' else '$'+convert (varchar(50),convert(float,round((Sum([ytdTotalColl])/Sum([ytdSttPatVisitQty])),2),0)) end,
case when Sum([ytdBdgPatients]) = 0 then '0' else '$'+convert (varchar(50),convert(float,round((Sum([ytdBdgTotalColl])/Sum([ytdBdgPatients])),2),0)) end,

case when Sum([ytdSttPatVisitQty]) = 0 or Sum([ytdBdgPatients]) = 0 or Sum([ytdNOR]) = 0 or Sum([ytdSttPatVisitQty]) = 0 then '0' 
	else dbo.fn_removeMinusSign(convert (varchar(50),convert(float,round(((Sum([ytdNOR])/Sum([ytdSttPatVisitQty]))-(Sum([ytdBdgNOR])/Sum([ytdBdgPatients])))/(Sum([ytdNOR])/Sum([ytdSttPatVisitQty]))*100,0),0))+'%') end, 
case when Sum([ytdSttPatVisitQty]) = 0 then '0' else '$'+convert (varchar(50),convert(float,round((Sum([ytdNOR])/Sum([ytdSttPatVisitQty])),2),0)) end,
case when Sum([ytdBdgPatients]) = 0 then '0' else '$'+convert (varchar(50),convert(float,round((Sum([ytdBdgNOR])/Sum([ytdBdgPatients])),2),0)) end,
...
case when Sum([ytdSttPatVisitQty]) = 0 then '0' else dbo.fn_FormatWithCommas(convert (varchar(50),convert(float,Sum([YtdSttACCExpenseAmt])/Sum([ytdSttPatVisitQty]),2))) end,
...
dbo.fn_FormatWithCommas(convert (varchar(50),convert(int,Sum([YtdSttOffTop]),0))),
case when Sum([ytdTotalColl]) = 0 then '0' else convert (varchar(50),convert(float,round(Sum([YtdSttOffTop])/Sum([ytdTotalColl])*100,2),2))+'%' end,
case when Sum([ytdSttPatVisitQty]) = 0 then '0' else dbo.fn_FormatWithCommas(convert (varchar(50),convert(float,round(Sum([YtdSttOffTop])/Sum([ytdSttPatVisitQty]),2),2))) end,
...
case when Sum([ytdSttPatVisitQty]) = 0 then '0' else '$'+dbo.fn_FormatWithCommas(convert (varchar(50),convert(money,(Sum([YtdSttOffTop])+Sum([YtdSttDonationAmt])+Sum([YtdSttCEPSurchargeAmt]))/Sum([ytdSttPatVisitQty])))) end,
...
dbo.fn_FormatWithCommas(convert (varchar(50),convert(int,Sum([YtdSttNonCurrMDAmt]),0))),
case when Sum([ytdNOR]) = 0 then '0' else convert (varchar(50),convert(float,round(Sum([YtdSttNonCurrMDAmt])/Sum([ytdNOR])*100,2),2)) end,
case when Sum([ytdTotalColl]) = 0 then '0' else convert (varchar(50),convert(float,round(Sum([YtdSttNonCurrMDAmt])/Sum([ytdTotalColl])*100,2),2)) end,
case when Sum([ytdSttPatVisitQty]) = 0 then '0' else convert (varchar(50),convert(float,round(Sum([YtdSttNonCurrMDAmt])/Sum([ytdSttPatVisitQty]),2),2)) end,

dbo.fn_FormatWithCommas(convert (varchar(50),convert(int,Sum([YtdSttNonCurrRDAmt]),0))),
case when Sum([ytdNOR]) = 0 then '0' else convert (varchar(50),convert(float,round(Sum([YtdSttNonCurrRDAmt])/Sum([ytdNOR])*100,2),2)) end,
case when Sum([ytdTotalColl]) = 0 then '0' else convert (varchar(50),convert(float,round(Sum([YtdSttNonCurrRDAmt])/Sum([ytdTotalColl])*100,2),2)) end,
case when Sum([ytdSttPatVisitQty]) = 0 then '0' else convert (varchar(50),convert(float,round(Sum([YtdSttNonCurrRDAmt])/Sum([ytdSttPatVisitQty]),2),2)) end,
...
where sttdate  >= '01/01/'+@firstDyYear and sttdate <= @sttDate
	and CtrID in (253, 254, 249, 281, 248) --Include Galen IDs
--WHERE  CtrID = 1 and SttDate >=  @sttDate   --changed to this 'where' based on actual SiteLine datase
