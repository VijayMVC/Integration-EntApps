CREATE TABLE [dbo].[tblGalen_Annual_Budget_Report] (
    ...
    [calcBdgEncounters2] VARCHAR (50)  NULL,
    [calcBdgEncounters3] VARCHAR (50)  NULL,
    ...
    CONSTRAINT [PK_tblGalen_Annual_Budget_Report] PRIMARY KEY CLUSTERED ([tblID] ASC)
);
