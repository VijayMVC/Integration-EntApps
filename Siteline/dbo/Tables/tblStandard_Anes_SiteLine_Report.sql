CREATE TABLE [dbo].[tblStandard_Anes_SiteLine_Report] (
    ...
    [BdgPatVisitUCQty]                  VARCHAR (50)  NULL,
    [ytdSttPatVisitUCQty]               VARCHAR (50)  NULL,
    [ytdBdgPatVisitUCQty]               VARCHAR (50)  NULL,
    [SttPhysTherVisitQty]               VARCHAR (50)  NULL,
    [BdgPhysTherVisitQty]               VARCHAR (50)  NULL,
    [ytdSttPhysTherVisitQty]            VARCHAR (50)  NULL,
    [ytdBdgPhysTherVisitQty]            VARCHAR (50)  NULL,
    ...
    [SttPACostHr]                       VARCHAR (50)  NULL,
    [BdgPACostHr]                       VARCHAR (50)  NULL,
    [ytdPACostHr]                       VARCHAR (50)  NULL,
    [ytdBdgPAPaidHrly]                  VARCHAR (50)  NULL,
    [SttAvgChgBilledUnit]               VARCHAR (50)  NULL,
    [bdgAvgChgBilledUnit]               VARCHAR (50)  NULL,
    [YTDSttAvgChgBilledUnit]            VARCHAR (50)  NULL,
    [ytdbdgAvgChgBilledUnit]            VARCHAR (50)  NULL,
