CREATE TABLE [dbo].[tblStandard_SiteLine_Report] (
    ...
    [SttTargetRate]                     VARCHAR (53)  NULL,
    [BdgTargetRate]                     VARCHAR (53)  NULL,
    [ytdSttTargetRate]                  VARCHAR (53)  NULL,
    [ytdBdgTargetRate]                  VARCHAR (53)  NULL,
    ...
    [SttSiteOvrHdPct]                   VARCHAR (53)  NULL,
    [calcSttSiteOverheadAmt]            VARCHAR (50)  NULL,
    [calcBdgSiteOverhead]               VARCHAR (50)  NULL,
    [calcytdSiteOverhead]               VARCHAR (50)  NULL,
    [ytdBdgSiteOverhead]                VARCHAR (50)  NULL,
