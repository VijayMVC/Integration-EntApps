CREATE TABLE [jagardg].[zzz2015BudgetImport] (
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Orientation', @value = 0, @level0type = N'SCHEMA', @level0name = N'jagardg', @level1type = N'TABLE', @level1name = N'zzz2015BudgetImport';
