CREATE VIEW SpearM.vwMngCarMarty
AS
SELECT     dbo.tblMngCar.*, dbo.tblCnt.CntKey AS Contact, dbo.tlkpRatTyp.RatTypName AS RatTypName, dbo.tlkpLiv.LivTypName AS LivTypName, 
                      ...
                      tblCmp2.CmpName AS Site, dbo.tblCtr.Ctr_RgnID AS Expr1
      ...
      Begin Tables = 
         ...
         Begin Table = "tlkpLiv (dbo)"
            Begin Extent = 
               ...
               Bottom = 411
               Right = 194
           ', @level0type = N'SCHEMA', @level0name = N'SpearM', @level1type = N'VIEW', @level1name = N'vwMngCarMarty';
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'SpearM', @level1type = N'VIEW', @level1name = N'vwMngCarMarty';
