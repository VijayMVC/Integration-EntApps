...
CREATE PROCEDURE [dbo].[usp_ScribeRetention] AS
BEGIN
...
INNER JOIN AppStaging.dbo.LawsonEMPLOYEE e ON ep.employee = e.employee
where ep.pos_level = 1
and e.JOB_CODE like '%SCRIBE%'
...
truncate table LawsonScribeRetention
;


insert into LawsonScribeRetention
select * 
from #tmpRetention
;
...
select * from LawsonScribeRetention
