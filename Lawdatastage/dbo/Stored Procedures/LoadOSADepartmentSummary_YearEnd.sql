...
-- =============================================
CREATE PROCEDURE [dbo].[LoadOSADepartmentSummary_YearEnd]
...
BEGIN
	...
	IF (@PeriodStartDate IS NULL)
		BEGIN
			SET @PeriodStartDate = (SELECT MAX(RangeEndDate) FROM OSASummaryTransaction WHERE CreateDate < '12/30/2015')
		END
...
********************************************************************************************************************************/
	...
	TRUNCATE TABLE OSASummaryTransactionStaging
	...
	*******************************************************************************************************/
	...
	---CheckDates inbtw	
	INSERT INTO dbo.OSASummaryTransactionStaging (CheckDate, CheckNo, PayPeriod, Dept, DeptDescr, 
...
INSERT INTO @ListOfOldOSA (CsuFlxIDeb)
	...
	(
		...
		SELECT DISTINCT CsuFlxIDeb, Dept
		FROM OSASummaryTransactionStaging
...
-----------------------------------------------------------------------------------------------------------
	...
	UPDATE OSASummaryTransactionStaging
	...
	DELETE OSASummaryTransactionStaging
...
-------------------------------------------------------------------------------------------------
	...
	SELECT @C= COUNT(*) 
		FROM OSASummaryTransactionStaging 
		WHERE CheckNo 
			IN (SELECT DISTINCT CheckNo FROM OSASummaryTransaction)
--	IF (@PayRollCheckDate IN (SELECT DISTINCT PayRollCheckDate FROM OSASummaryTransaction))
	...
	INSERT INTO dbo.OSASummaryTransaction ( CheckDate, CheckNo, PayPeriod, Dept, DeptDescr, 
						CsuFlxIDeb, ProviderMasterID, LastName, FirstName, 
						MiddleName, FullName, PayCode, PayCodeDescr, TotalCurrentHours, 
...
INSERT INTO dbo.OSASummarySubtotals (PayRollCheckDate,
					PayRollPayPeriod,
