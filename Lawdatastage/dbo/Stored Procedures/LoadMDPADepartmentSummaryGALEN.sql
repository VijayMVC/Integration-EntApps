CREATE PROCEDURE [dbo].[LoadMDPADepartmentSummaryGALEN]
...
BEGIN
	...
	IF (@PeriodStartDate IS NULL)
		BEGIN
			SET @PeriodStartDate = (SELECT MAX(RangeEndDate) FROM PASummaryTransactionGALEN WHERE CreateDate < GETDATE()-1)
		END
