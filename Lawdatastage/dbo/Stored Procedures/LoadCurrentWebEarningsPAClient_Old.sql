...
*/
CREATE PROCEDURE [dbo].[LoadCurrentWebEarningsPAClient_Old]
...
--	BEGIN TRY
--		BEGIN TRANSACTION;
				-- this sp is dependent on the LawsonIDMatch table for ProviderMasterID
				...
				INSERT INTO YTDEarningsStatementStagingPA (CsuFlxIDeb, ProviderMasterID, CheckDate, CheckNo,
					...
					SELECT DISTINCT   EMP.EMPLOYEE 
						...
						LEFT JOIN	dbo.LawsonIDMatch MP ON EMP.EMPLOYEE = MP.LawsonEmpNo
				...
				INSERT INTO YTDEarningsStatementStagingPA (CsuFlxIDeb, ProviderMasterID, CheckDate,CheckNo,
						...
						SELECT DISTINCT EMP.EMPLOYEE
									...
									, PYM.CHECK_ID
						FROM		dbo.EMPLOYEE EMP
						JOIN		dbo.LawsonIDMatch MP ON EMP.EMPLOYEE = MP.LawsonEmpNo	
