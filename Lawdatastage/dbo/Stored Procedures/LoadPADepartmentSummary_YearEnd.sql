...
-- =============================================
CREATE PROCEDURE [dbo].[LoadPADepartmentSummary_YearEnd]
...
BEGIN
	...
	IF (@PeriodStartDate IS NULL)
		BEGIN
			SET @PeriodStartDate = (SELECT MAX(RangeEndDate) FROM PASummaryTransaction WHERE CreateDate < '12/30/2015')
		END
...
********************************************************************************************************************************/
	...
	IF @err <>  0
		BEGIN
			...
			VALUES ('PA', '12/31/2015', 'Error @ position 1') 
	...
	INSERT INTO @ListOfMidlevels (CsuFlxIDeb)
		...
		JOIN PAEMPLOYEE C ON C.EMPLOYEE = A.EMPLOYEE
		WHERE JOB_CLASS = 'MDL'
		AND HIRE_SOURCE <> 'AUC'
		AND HIRE_SOURCE <> 'VISA'
	...
	IF @err <>  0
		BEGIN
			...
			INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage)
			VALUES ('PA', '12/31/2015', 'Error @ position 2') 
	...
	*******************************************************************************************************/
	...
	IF @err <>  0
		BEGIN
			...
			INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage)
			VALUES ('PA', '12/31/2015', 'Error @ position 3') 
...
--			PRINT 'Error @ position 4'
			INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage)
			VALUES ('PA', '12/31/2015', 'Error @ position 4') 
...
--			PRINT 'Error @ position 5'
			INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage)
			VALUES ('PA', '12/31/2015', 'Error @ position 5') 
...
--			PRINT 'Error @ position 6'
			INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage)
			VALUES ('PA', '12/31/2015', 'Error @ position 6') 
...
--			PRINT 'Error @ position 7'
			INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage)
			VALUES ('PA', '12/31/2015', 'Error @ position 7') 
...
-----------------------------------------------------------------------------------------------------------
	...
	DELETE PASummaryTransactionStaging
...
--			PRINT 'Error @ position 8'
			INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage)
			VALUES ('PA', '12/31/2015', 'Error @ position 8') 
...
-------------------------------------------------------------------------------------------------
	...
	SELECT @C= COUNT(*) 
		FROM PASummaryTransactionStaging 
		WHERE CheckNo 
			IN (SELECT DISTINCT CheckNo FROM PASummaryTransaction)
--	IF (@PayRollCheckDate IN (SELECT DISTINCT PayRollCheckDate FROM PASummaryTransaction))

	---Append this PayRollCheckDate into the Transaction table from the staging table.
	INSERT INTO dbo.PASummaryTransaction ( CheckDate, CheckNo, PayPeriod, Dept, DeptDescr, 
						CsuFlxIDeb, ProviderMasterID, LastName, FirstName, 
						MiddleName, FullName, PayCode, PayCodeDescr, TotalCurrentHours, 
...
--	IF (@PayRollCheckDate IN (SELECT DISTINCT PayRollCheckDate FROM PASummarySubtotals))
...
--			PRINT 'Error @ position 11'
			INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage)
			VALUES ('PA', '12/31/2015', 'Error @ position 11') 
...
--			PRINT 'Error @ position 12'
			INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage)
			VALUES ('PA', '12/31/2015', 'Error @ position 12') 
			
		END

---Now its time to group together the checkdates
INSERT INTO dbo.PASummarySubtotals (PayRollCheckDate,
					PayRollPayPeriod,
...
--			PRINT 'Error @ position 13'
			INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage)
			VALUES ('PA', '12/31/2015', 'Error @ position 13') 
...
--			PRINT 'Error @ position 14'
			INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage)
			VALUES ('PA', '12/31/2015', 'Error @ position 14') 
...
--			PRINT 'Error @ position 15'
			INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage)
			VALUES ('PA', '12/31/2015', 'Error @ position 15') 
...
--			PRINT 'Error @ position 16'
			INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage)
			VALUES ('PA', '12/31/2015', 'Error @ position 16.') 
			
		END

	INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage, PayRollCheckDate, RangeStartDate, RangeEndDate)
	VALUES ('PA', '12/31/2015', 'Looks like it made it to the end', @PayRollCheckDate, @PeriodStartDate, @PeriodEndDate ) 
END
