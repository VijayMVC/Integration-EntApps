...
-- =============================================
CREATE PROCEDURE [dbo].[LoadScribeDepartmentSummary_YearEnd]
...
BEGIN
	...
	IF (@PeriodStartDate IS NULL)
		BEGIN
			SET @PeriodStartDate = (SELECT MAX(RangeEndDate) FROM ScribeSummaryTransaction WHERE CreateDate < '12/30/2015')
		END
...
********************************************************************************************************************************/
	...
	IF @err <>  0
		BEGIN
			...
			VALUES ('SC', '12/31/2015', 'Error @ position 1') 
	...
	IF @err <>  0
		BEGIN
			...
			INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage)
			VALUES ('SC', '12/31/2015', 'Error @ position 2') 
	...
	*******************************************************************************************************/
	...
	IF @err <>  0
		BEGIN
			...
			INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage)
			VALUES ('SC', '12/31/2015', 'Error @ position 3') 
...
--			PRINT 'Error @ position 4'
			INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage)
			VALUES ('SC', '12/31/2015', 'Error @ position 4') 
...
--			PRINT 'Error @ position 5'
			INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage)
			VALUES ('SC', '12/31/2015', 'Error @ position 5') 
...
--			PRINT 'Error @ position 6'
			INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage)
			VALUES ('SC', '12/31/2015', 'Error @ position 6') 
...
--			PRINT 'Error @ position 7'
			INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage)
			VALUES ('SC', '12/31/2015', 'Error @ position 7') 
...
--			PRINT 'Error @ position 8'
			INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage)
			VALUES ('SC', '12/31/2015', 'Error @ position 8') 
...
--			PRINT 'Error @ position 11'
			INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage)
			VALUES ('SC', '12/31/2015', 'Error @ position 11') 
...
--			PRINT 'Error @ position 12'
			INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage)
			VALUES ('SC', '12/31/2015', 'Error @ position 12') 
...
--			PRINT 'Error @ position 13'
			INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage)
			VALUES ('SC', '12/31/2015', 'Error @ position 13') 
...
--			PRINT 'Error @ position 14'
			INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage)
			VALUES ('SC', '12/31/2015', 'Error @ position 14') 
...
--			PRINT 'Error @ position 15'
			INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage)
			VALUES ('SC', '12/31/2015', 'Error @ position 15') 
...
--			PRINT 'Error @ position 16'
			INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage)
			VALUES ('SC', '12/31/2015', 'Error @ position 16.') 
			
		END

	INSERT INTO ErrorMsg (SPName, ErrorDate, ErrorMessage, PayRollCheckDate, RangeStartDate, RangeEndDate)
	VALUES ('SC', '12/31/2015', 'Looks like it made it to the end', @PayRollCheckDate, @PeriodStartDate, @PeriodEndDate ) 
END
