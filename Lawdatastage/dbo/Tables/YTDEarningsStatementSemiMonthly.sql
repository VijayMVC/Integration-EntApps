CREATE TABLE [dbo].[YTDEarningsStatementSemiMonthly] (
    [CsuFlxID]                 INT             NULL,
    [CsuFlxIDeb]               INT             NULL,
    ...
    [YTDUnitsBySite]           DECIMAL (10, 2) NULL,
