...
CREATE Procedure [dbo].[usp_SFDC_UploadDataFromOnboarding_Phase2]
...
--Case 1  - Hospital affiliations -- INSERT(new records)
	INSERT INTO SALESFORCESB...Work_History__c
	(Contact__c,
...
--Case 1  - Hospital affiliations -- Update(existing records)
	...
	UPDATE SALESFORCESB...Work_History__c
...
-- Case 1 - Type = Drivers License -- INSERT(New Records)
	...
	INSERT INTO SALESFORCESB...Professional_Credentials__c(
	Contact__c,
	Type__c,
	...
	WHERE PA.SF_Flag = 'Ready4SF'
		...
		AND PA.ProviderType_Flag IN ('RC', 'RH')
		AND NOT EXISTS(SELECT *
					FROM SALESFORCESB...Professional_Credentials__c PC
...
--THIS WILL ONLY BE AN UPDATE FOR RC AND RH
	UPDATE SALESFORCESB...Professional_Credentials__c
	...
	FROM AppStaging.dbo.OnboardProviderAccountForSFDC AS PA
	JOIN SalesforceSB...Contact AS Contact ON Contact.Id = PA.SFID 
...
--Case 1 - Country = 'USA' -- INSERT(New Records)
	...
	INSERT INTO SALESFORCESB...Education__c
	( Contact__c,
	Education_Type__c,
	Institution_1__c,
	Degree__c,
...
--Case 1 - Country = 'USA' -- UPDATE(Existing Records)
	UPDATE SALESFORCESB...Education__c
...
*/
	...
	INSERT INTO SALESFORCESB...Malpractice_Carriers__c
	(Contact__c, 
	Carrier__c,
	Policy_number__c,
	...
	UPDATE SALESFORCESB...Malpractice_Carriers__c
...
--Following makes sure no invalid email addresses go to SFDC
	...
	INSERT INTO SALESFORCESB...Credentialing_Reference__c (
	Provider__c,
	Name__c,
	Email__c,
	Phone__c,
...
*/
	...
	INSERT INTO SALESFORCESB...Specialty__c
	(Contact__c,
	Specialty__c,
	Certified__c,
	Expiration_Date__c,
	...
	UPDATE SALESFORCESB...Specialty__c
