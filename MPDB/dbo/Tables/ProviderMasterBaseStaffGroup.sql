CREATE TABLE [dbo].[ProviderMasterBaseStaffGroup] (
    ...
    [CorporateLevel]            VARCHAR (5)    NULL,
    [CorporateLevelDate]        SMALLDATETIME  NULL,
    [HireDate]                  SMALLDATETIME  NULL,
    [Notes]                     VARCHAR (2000) NULL,
    [TimeStmp]                  DATETIME       NULL,
    [Author]                    VARCHAR (60)   NULL,
    [UpdatedFlag]               CHAR (1)       NULL,
    [Status]                    CHAR (1)       CONSTRAINT [DF_ProviderMasterBaseStaffGroup_Status] DEFAULT (0) NULL,
    CONSTRAINT [FK_ProviderMasterBaseStaffGroup_ProviderMaster] FOREIGN KEY ([ProviderMasterID]) REFERENCES [dbo].[ProviderMaster] ([ProviderMasterID])
);


GO
CREATE CLUSTERED INDEX [PMBSG_StaffGroup_ProvMasterID_idx]
    ON [dbo].[ProviderMasterBaseStaffGroup]([StaffGroup] ASC, [ProviderMasterID] ASC) WITH (FILLFACTOR = 90);
