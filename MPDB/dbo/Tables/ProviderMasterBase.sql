CREATE TABLE [dbo].[ProviderMasterBase] (
    ...
    [Status]                    CHAR (1)       CONSTRAINT [DF_ProviderMasterBase_Status] DEFAULT (0) NULL,
    CONSTRAINT [FK_ProviderMasterBase_ProviderMaster] FOREIGN KEY ([ProviderMasterID]) REFERENCES [dbo].[ProviderMaster] ([ProviderMasterID])
);


GO
CREATE CLUSTERED INDEX [PMB_ProviderMasterID_idx]
    ON [dbo].[ProviderMasterBase]([ProviderMasterID] ASC) WITH (FILLFACTOR = 90);
