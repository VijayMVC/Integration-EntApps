CREATE TABLE [dbo].[ProviderAddressStaffGroup] (
    ...
    [CreDate]                  DATETIME      CONSTRAINT [DF_ProviderAddressSG_CreDate] DEFAULT (getdate()) NULL,
    [UpdDate]                  DATETIME      CONSTRAINT [DF_ProviderAddressSG_UpdDate] DEFAULT (getdate()) NULL,
    CONSTRAINT [FK_ProviderAddressSG_ProviderMaster] FOREIGN KEY ([ProviderMasterID]) REFERENCES [dbo].[ProviderMaster] ([ProviderMasterID])
);
