CREATE TABLE [dbo].[TempProviderMaster] (
...
GO
CREATE UNIQUE CLUSTERED INDEX [Temp_ProviderMaster_ProviderMasterID_idx]
    ON [dbo].[TempProviderMaster]([ProviderMasterID] ASC) WITH (FILLFACTOR = 90);
