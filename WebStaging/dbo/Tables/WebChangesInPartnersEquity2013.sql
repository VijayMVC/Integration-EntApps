CREATE TABLE [dbo].[WebChangesInPartnersEquity2013] (
    ...
    [Line12PE]         DECIMAL (10, 4) NULL,
    [Line13]           DECIMAL (18, 4) NULL,
    ...
    [Credate]          DATETIME        CONSTRAINT [DF_WebChangesInPartnersEquity2013_Credate] DEFAULT (getdate()) NULL
);
