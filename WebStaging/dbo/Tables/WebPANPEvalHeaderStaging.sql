CREATE TABLE [dbo].[WebPANPEvalHeaderStaging] (
    ...
    [CeridianDeptNo]            CHAR (4)        NULL,
    [Reviewer]                  VARCHAR (50)    NULL,
    [ReviewerClockNo]           INT             NULL,
    [Credate]                   DATETIME        CONSTRAINT [DF_WebPANPEvalHeaderStaging_Credate] DEFAULT (getdate()) NULL
);
